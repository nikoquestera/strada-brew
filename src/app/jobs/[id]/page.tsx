  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] font-sans pb-20">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-8">
        ...
        {/* CTA */}
        <div className="bg-strada-foam/30 rounded-[40px] p-10 md:p-16 text-center border border-strada-foam shadow-sm relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-strada-blue/5 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl"></div>
          
          <h2 className="text-[11px] font-black tracking-[0.3em] text-strada-blue uppercase mb-4 opacity-80">TERTARIK BERGABUNG?</h2>
          <h3 className="text-3xl md:text-4xl font-[900] text-gray-900 mb-6 tracking-tight">Kirim Lamaran Kamu</h3>
          <p className="text-gray-600 text-base md:text-lg max-w-xl mx-auto mb-10 leading-relaxed font-medium">
          ...
          <Link href={`/apply?job=${job.job_id}`} 
            className="inline-block bg-strada-blue text-white px-12 py-4 rounded-full font-[900] text-base shadow-lg shadow-strada-blue/20 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 active:translate-y-0">
            Lamar Sekarang →
          </Link>
          
          <p className="text-[11px] text-gray-400 mt-8 font-bold uppercase tracking-widest">
